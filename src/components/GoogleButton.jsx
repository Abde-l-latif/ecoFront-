...
export default function GoogleButton() {
    ...
    signInWithPopup(auth, provider)
      .then(async (result) => {
        try {
          ...
          if (!Oauth.ok) {
            return dispatch(signinError(Oauth.message || "signin failed !!"));
          }
          const res = await Oauth.json();
  ...
  return (
    <>
      <div
        className="bg-gray-300 p-3 rounded-full cursor-pointer hover:bg-gray-400"
        onClick={googleOaut}
      >
        <svg
          viewBox="-3 0 262 262"
